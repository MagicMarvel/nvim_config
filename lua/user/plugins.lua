...
packer.init({
    -- 快照保存地点，默认在~/.cache/nvim/packer.nvim里
    -- snapshot_path = join_paths(vim.fn.stdpath('config')),
    display = {
        open_fn = function()
...
return packer.startup(function(use)
    ...
    use { "folke/neodev.nvim", commit = "071c8895bbff0e4d1d3d4c531adfe20e3a2a6e82" }
    ...
    use({
        ...
        run = function() vim.fn["mkdp#util#install"]() end, commit = "02cc3874738bc0f86e4b91f09b8a0ac88aef8e96"
    })
